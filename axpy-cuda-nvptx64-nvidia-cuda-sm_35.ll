...
define dso_local void @_Z4testv() #1 {
entry:
...
; Function Attrs: convergent noinline nounwind optnone
define dso_local void @_Z4axpyfPfS_(float %a, float* %x, float* %y) #0 {
entry:
  ...
  %2 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x() #3, !range !10
  ...
  %5 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x() #3, !range !10
...
attributes #1 = { alwaysinline convergent nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="sm_35" "target-features"="+ptx64,+sm_35" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
!3 = !{void (float, float*, float*)* @_Z4axpyfPfS_, !"kernel", i32 1}
!4 = !{null, !"align", i32 8}
!5 = !{null, !"align", i32 8, !"align", i32 65544, !"align", i32 131080}
!6 = !{null, !"align", i32 16}
!7 = !{null, !"align", i32 16, !"align", i32 65552, !"align", i32 131088}
!8 = !{!"clang version 9.0.0 (https://github.com/morimolymoly/llvm.git f7f3c2919a97198083f994fce16cd2b09010f77a)"}
!9 = !{i32 1, i32 4}
!10 = !{i32 0, i32 1024}
